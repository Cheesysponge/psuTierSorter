...
for i in range(1,5):
    url = "https://"+region+"pcpartpicker.com/products/power-supply/#X=101,98698&sort=price&xcx=0&e=6,5,4,3,2,1&page="+str(i)
    params = {
...
with open(region+"psus_scraped.csv", "w", newline="", encoding="utf-8") as f:
